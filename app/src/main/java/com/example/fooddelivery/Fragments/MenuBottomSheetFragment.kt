...
class MenuBottomSheetFragment : BottomSheetDialogFragment() {
    ...
    override fun onCreateView(
        ...
        menuList = ArrayList()
        menuList.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$"))
        menuList.add(PopularModel(R.drawable.pop_menu_2, "Food", "2$"))
        menuList.add(PopularModel(R.drawable.pop_menu_3, "momo", "9$"))
        menuList.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$"))
        menuList.add(PopularModel(R.drawable.pop_menu_2, "Food", "2$"))
        menuList.add(PopularModel(R.drawable.pop_menu_3, "momo", "9$"))
        menuList.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$"))
