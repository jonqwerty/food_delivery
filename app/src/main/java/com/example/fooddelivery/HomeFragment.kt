...
import com.example.fooddelivery.Fragments.MenuBottomSheetFragment
...
private lateinit var sharedModel : SharedModel
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", 7,7,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_2, "Food", 2,2,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_3, "momo", 5,5,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", 7,7,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_2, "Food", 2,2,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_3, "momo", 5,5,1))
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", 7,7,1))
