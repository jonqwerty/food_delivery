...
private lateinit var goMenuText : TextView
    ...
    override fun onCreateView(
        ...
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_2, "Food", "2$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_3, "momo", "9$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_2, "Food", "2$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_3, "momo", "9$",1))
        listPopular.add(PopularModel(R.drawable.pop_menu_1, "Sandwich", "7$",1))
